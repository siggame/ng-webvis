...
(function() {
  ...
  angular.module('webvisApp').provide.factory('Droids', function(PluginBase, Renderer, Options) {
    var Droids;
    Droids = (function(_super) {
      var Droid;

      __extends(Droids, _super);
      ...
      Droids.prototype.Droid = Droid = (function(_super1) {
        __extends(Droid, _super1);
      ...
      })(PluginBase.BaseEntity);

      Droids.prototype.getName = function() {
        return "Droids";
      };

      Droids.prototype.getMaxTurn = function() {
        return this.maxTurn;
      };

      Droids.prototype.getMapWidth = function() {
        return this.mapWidth;
      };

      Droids.prototype.getMapHeight = function() {
        return this.mapHeight;
      };

      Droids.prototype.preDraw = function(renderer) {
      ...
      Droids.prototype.getEntities = function() {
        return this.entities;
      };

      Droids.prototype.postDraw = function(renderer) {};

      Droids.prototype.isLoaded = function() {
        return this.gameLoaded;
      };

      Droids.prototype.loadGame = function(gamedata) {
      ...
      Droids.prototype.getSexpScheme = function() {
        var scheme;
        scheme = {
          gameName: ["gameName"],
